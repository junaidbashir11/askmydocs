...
export default function MedicalDive(){
    ...
    const medicaldeepdive=async ()=> {
              setLoading(true);
  try {
    const request = await fetch("https://junaidb-askdocs.hf.space/medicaldeepdive", {
      method: "POST",
      mode: "cors",
      body: JSON.stringify({
        owner: publicKey?.toBase58(),
