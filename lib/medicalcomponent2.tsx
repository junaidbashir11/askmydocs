...
export default function MedicalComponent2(){
    ...
    const medicalbreakdown=async ()=> {

        //setProblems([]);
                      setLoading(true);
  try {
    const request = await fetch("https://junaidb-askdocs.hf.space/medicalbreakdown", {
      method: "POST",
      mode: "cors",
      body: JSON.stringify({
        owner: publicKey?.toBase58(),
